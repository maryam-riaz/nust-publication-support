...
**Tech stack:** Vanilla JavaScript (ES6), CSS3 custom properties (dark/light themes), HTML5 semantic markup. No frameworks or build tools.

**Source files:**
- `index.html` — 3-view SPA (landing, wizard/stepper, result/calculator)
- `app.js` (~1110 lines) — state machine, question database, eligibility logic, calculator engines
- `style.css` (~1236 lines) — design system with dark/light mode, responsive grid, animations
...
**Base Award Formula:**
```
baseAward = 45,000 + 30,000 × (TJ − PJ) / (TJ − 1)
```
...
**Award range:** Rs. 45,000 (worst position) to Rs. 75,000 (best position, or if TJ = 1).

**Author share tables:** Same as APC — [100], [60,40], [50,35,15], [45,30,15,10].
...
| FA formula: `45000 + 30000 × (TJ-PJ)/(TJ-1)` | ✅ Present | Implemented in `updateFACalculation()` |
...
| Eligibility evaluation | `app.js` | 524–608 |
| APC Calculator | `app.js` | 611–811 |
| FA Calculator | `app.js` | 814–1043 |
| Author share computation | `app.js` | 1046–1105 |
| Design system (variables) | `style.css` | 1–60 |
| Landing cards grid | `style.css` | 208–318 |
| Wizard/stepper | `style.css` | 370–520 |
| Result & calculator layout | `style.css` | 711–1131 |

---

*Document generated from the source code (`app.js`, `index.html`, `style.css`) and the official policy working papers: WP#68 (73rd ACM, 09 Feb 2026), WP#66 (73rd ACM, 09 Feb 2026), and WP#65 (73rd ACM, 09 Feb 2026).*
